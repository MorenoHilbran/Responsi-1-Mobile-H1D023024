...
import com.example.responsi1mobileh1d023024.data.model.Coach
...
class HeadCoachActivity : AppCompatActivity() {
    ...
    private fun populateCoachData(coach: Coach) {
        ...
        coachNationalityText.text = "Nationality: ${coach.nationality}"
        coachDobText.text = "Born: ${formatDate(coach.dateOfBirth)}"
    }
